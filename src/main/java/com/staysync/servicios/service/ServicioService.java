...
public class ServicioService {
    ...
    @Transactional
    @CircuitBreaker(name = "reservasCB", fallbackMethod = "crearSolicitudFallback")
    ...
    public SolicitudServicioResponse crearSolicitudFallback(SolicitudServicioRequest request, Exception ex) {
        log.error("Circuit Breaker activo al crear solicitud de servicio: {}", ex.getMessage());
        throw new RuntimeException("Servicio de reservas no disponible. Intente más tarde.");
    }
